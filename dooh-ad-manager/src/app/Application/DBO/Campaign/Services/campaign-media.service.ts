...
import { CampaignMedia, CampaignMediaDelete, CampaignMediaDeleted, CampaignMediaFilter, CampaignMediaInsert, CampaignMediaUpdate } from '../Models/campaign-media';
...
export class CampaignMediaService {
  ...
  getCampaignMedia(
    ...
    return this.http.get<ApiResponse<MvGridConfig<CampaignMedia>>>(    `${this.baseUrl}?Offset=${offset}&PageSize=${pageSize}`+
  ...
  addCampaignMedia(data: CampaignMediaInsert): Observable<ApiResponse<CampaignMedia>> {
    return this.http.post<ApiResponse<CampaignMedia>>(this.baseUrl, data);
  }

  updateCampaignMedia(data: CampaignMediaUpdate): Observable<ApiResponse<CampaignMedia>> {
    return this.http.put<ApiResponse<CampaignMedia>>(this.baseUrl, data);
  }

  deleteCampaignMedia (data: CampaignMediaDelete): Observable<ApiResponse<CampaignMediaDeleted>> {
